                  ...
                  <div className="flex my-4 md:w-2/3 lg:w-full">
                    ...
                    <div className="flex flex-col">
                      <h2 className="text-2xl">
                        Jane Gatwiri Rukaria C/O Mulwa &amp; Company Advocates
                      </h2>
                      <h3>Rukaria, Mulwa, Associates</h3>
                      <p className="text-gray-400">
                        PO Box 40589 Mombasa Kenya
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:flex md:gap-10">
                        <div>
                          <h3>Canada</h3>
                          <p className="text-gray-400">
                            Phone: +1 604.708.5977
                          </p>
                          <p className="text-gray-400">
                            Mobile: +1 604.3418496
                          </p>
